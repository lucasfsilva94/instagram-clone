  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
      ...
      <div className="relative mt-1 p-3 rounded-md">
        ...
        <input type="text" className="bg-gray-50 block w-full pl-10 
                                      sm:text-sm border-gray-300 focus:ring-black 
                                      focus:border-black rounded-md" placeholder="Search"></input>
      </div>
      </div>
      ...
      <div className="relative navBtn">
        ...
        <div className="absolute -top-2 -right-1 text-xs w-5 h-5 
                      ...
                      justify-center animate-pulse text-white pointer-events-none">3</div>
      </div>
